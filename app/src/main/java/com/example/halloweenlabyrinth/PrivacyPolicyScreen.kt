...
fun PrivacyPolicyScreen(navController: NavController) {
    Column(
        ...
        Text(
            text = "\n" +
                    "\n" +
                    "Privacy Policy for HalloweenLabyrinth\n" +
                    "Privacy Policy\n" +
                    "\n" +
                    ...
                    "\n" +
                    "    Application refers to HalloweenLabyrinth, the software program provided by the Company.\n" +
                    "\n" +
                    "    Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to HalloweenLabyrinth.\n" +
                    "\n" +
                    ...
                    "\n" +
                    "    By email: HalloweenLabyrinth@proton.me\n",
            modifier = Modifier
                .weight(1f)
        ...
        Row(
            ...
            Button(onClick = { /* Handle deny logic */ }) {
                Text(text = "Deny")
            }
        }
    }
...
fun AppNavigator() {
    ...
    NavHost(navController = navController, startDestination = "privacy_policy_route") {
...
fun RememberUserChoice() {
    ...
    var userChoice by rememberSaveable {
        mutableStateOf(sharedPreferences.getBoolean("policy_accepted", false))
    }

    LaunchedEffect(userChoice) {
        with(sharedPreferences.edit()) {
            putBoolean("policy_accepted", userChoice)
            apply()
        }
    }

    // TODO: Your UI here, which updates userChoice accordingly.
}